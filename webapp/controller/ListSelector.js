sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("alterno.GIT_EX.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias alterno.GIT_EX.controller.ListSelector
			 */
			 ...
			 * @return {alterno.GIT_EX.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
