sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("alterno/GIT_EX/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("alterno.GIT_EX.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["alterno/GIT_EX/localService/mockserver"], function (mockserver) {
